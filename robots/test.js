...
robot.links = {"link1": {}, "link2": {}, "link3": {}, "link4": {}, "link5": {}};
...
//robot.joints.joint3.axis = [0.707,-0.707,0];
robot.joints.joint4.axis = [Math.cos(Math.PI/4),-Math.cos(Math.PI/4),0];
...
links_geom["link5"] = new THREE.CubeGeometry( 0.5+0.2, 0.2, 0.2 );
links_geom["link5"].applyMatrix( new THREE.Matrix4().makeTranslation(0.5/2, 0, 0) );
